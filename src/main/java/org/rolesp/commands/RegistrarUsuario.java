...
public class RegistrarUsuario extends BotCommand {

    public static final String LOGTAG = "REGISTRARUSUARIO";
    ...
    public void execute(AbsSender absSender, User user, Chat chat, Integer messageId, String[] strings) {
        Usuario usuario = new Usuario(user.getFirstName(), user.getUserName(), "Usuario", user.getId());
